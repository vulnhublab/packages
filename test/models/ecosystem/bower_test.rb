...
class BowerTest < ActiveSupport::TestCase
  ...
  test 'versions_metadata' do
    stub_request(:get, "https://repos.khulnasoft.com/api/v1/repositories/lookup?url=https://github.com/angular/bower-angular")
      .to_return({ status: 200, body: file_fixture('bower/lookup?url=https:%2F%2Fgithub.com%2Fangular%2Fbower-angular') })
    stub_request(:get, "https://repos.khulnasoft.com/api/v1/hosts/GitHub/repositories/angular/bower-angular/tags")
