...
class ActionsTest < ActiveSupport::TestCase
  ...
  test 'all_package_names' do
    stub_request(:get, "https://repos.khulnasoft.com/api/v1/package_names/actions")
  ...
  test 'package_metadata' do
    stub_request(:get, "https://repos.khulnasoft.com/api/v1/repositories/lookup?url=https://github.com/getsentry/action-git-diff-suggestions")
    ...
    stub_request(:get, "http://repos.khulnasoft.com/api/v1/hosts/GitHub/repositories/getsentry%2Faction-git-diff-suggestions/tags?per_page=1000")
    ...
    assert_equal package_metadata, {
      ...
      :keywords_array=>[], 
      :homepage=>nil, 
      :tags_url=>"http://repos.khulnasoft.com/api/v1/hosts/GitHub/repositories/getsentry%2Faction-git-diff-suggestions/tags", 
      :namespace=>"getsentry", 
