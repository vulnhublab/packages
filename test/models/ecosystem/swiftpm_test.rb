...
class SwiftpmTest < ActiveSupport::TestCase
  ...
  test 'package_metadata' do
    stub_request(:get, "https://repos.khulnasoft.com/api/v1/repositories/lookup?url=https://github.com/swift-cloud/Compute")
    ...
    assert_equal package_metadata, {
      ...
      :tags_url=>"http://repos.khulnasoft.com/api/v1/hosts/GitHub/repositories/swift-cloud%2FCompute/tags",
      :namespace=>"swift-cloud"
    }
  end

  test 'versions_metadata' do
    stub_request(:get, "http://repos.khulnasoft.com/api/v1/hosts/GitHub/repositories/swift-cloud%2FCompute/tags")
