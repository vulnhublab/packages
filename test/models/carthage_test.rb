...
class CarthageTest < ActiveSupport::TestCase
  ...
  test 'all_package_names' do
    stub_request(:get, "https://repos.khulnasoft.com/api/v1/package_names/carthage")
  ...
  test 'package_metadata' do
    stub_request(:get, "https://repos.khulnasoft.com/api/v1/repositories/lookup?url=https://github.com/Carthage/ReactiveTask")
    ...
    assert_equal package_metadata, {
      ...
      :homepage=>"",
      :tags_url=>"http://repos.khulnasoft.com/api/v1/hosts/GitHub/repositories/Carthage%2FReactiveTask/tags",
      :namespace=>"Carthage"
    }
  end

  test 'versions_metadata' do
    stub_request(:get, "http://repos.khulnasoft.com/api/v1/hosts/GitHub/repositories/Carthage%2FReactiveTask/tags")
