...
class RegistryTest < ActiveSupport::TestCase
  ...
  test 'sync_package' do
    ...
    stub_request(:get, "https://repos.khulnasoft.com/api/v1/repositories/lookup?url=https://github.com/phillbaker/rubystats")
    ...
    stub_request(:get, "https://issues.khulnasoft.com/api/v1/hosts/GitHub/repositories/phillbaker/rubystats")
      .to_return({ status: 200 })
    stub_request(:get, "https://issues.khulnasoft.com/api/v1/hosts/GitHub/repositories/phillbaker/rubystats/ping")
      .to_return({ status: 200 })
