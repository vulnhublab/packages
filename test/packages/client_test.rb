...
class PackagesTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    stub_request(:get, "http://localhost/packages/lookup").to_return_json(status: 500, body: {})

    packages = Packages::Client.new(base_url: "http://localhost", api_key: "My API Key")

    assert_raises(Packages::Errors::InternalServerError) do
  ...
  def test_client_given_request_default_retry_attempts
    ...
    packages = Packages::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 3)
  ...
  def test_client_default_request_given_retry_attempts
    ...
    assert_raises(Packages::Errors::InternalServerError) do
      packages.packages.lookup(request_options: {max_retries: 3})
    end
  ...
  def test_client_given_request_given_retry_attempts
    ...
    assert_raises(Packages::Errors::InternalServerError) do
      packages.packages.lookup(request_options: {max_retries: 4})
    end
  ...
  def test_client_retry_after_seconds
    stub_request(:get, "http://localhost/packages/lookup").to_return_json(
      status: 500,
      headers: {"retry-after" => "1.3"},
      body: {}
    )

    packages = Packages::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 1)
  ...
  def test_omit_retry_count_header
    ...
    assert_raises(Packages::Errors::InternalServerError) do
      packages.packages.lookup(request_options: {extra_headers: {"x-stainless-retry-count" => nil}})
    end
  ...
  def test_overwrite_retry_count_header
    ...
    assert_raises(Packages::Errors::InternalServerError) do
      packages.packages.lookup(request_options: {extra_headers: {"x-stainless-retry-count" => "42"}})
    end
  ...
  def test_client_redirect_307
    ...
    assert_raises(Packages::Errors::APIConnectionError) do
      packages.packages.lookup(request_options: {extra_headers: {}})
    end

    recorded, = WebMock::RequestRegistry.instance.requested_signatures.hash.first

    assert_requested(:any, "http://localhost/redirected", times: Packages::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: Packages::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_keep_same_origin
    ...
    assert_raises(Packages::Errors::APIConnectionError) do
      packages.packages.lookup(request_options: {extra_headers: {"authorization" => "Bearer xyz"}})
    end
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: Packages::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
  ...
  def test_default_headers
    stub_request(:get, "http://localhost/packages/lookup").to_return_json(status: 200, body: {})
