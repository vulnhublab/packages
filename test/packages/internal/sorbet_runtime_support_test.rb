...
class Packages::Test::SorbetRuntimeSupportTest < Minitest::Test
  ...
  class M < Packages::Internal::Type::BaseModel
  ...
  def test_nil_aliases
    ...
    assert_raises(err) { Packages::Internal::Type::BaseModel::KnownField }
    assert_raises(err) { Packages::Internal::Util::ParsedUri }
    assert_raises(err) { Packages::Internal::Util::ServerSentEvent }
    assert_raises(err) { Packages::Internal::Transport::BaseClient::RequestComponents }
    assert_raises(err) { Packages::Internal::Transport::BaseClient::RequestInput }
    assert_raises(err) { Packages::Internal::Transport::PooledNetRequester::Request }
