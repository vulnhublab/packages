...
class Packages::Test::PrimitiveModelTest < Minitest::Test
  A = Packages::Internal::Type::ArrayOf[-> { Integer }]
  H = Packages::Internal::Type::HashOf[-> { Integer }, nil?: true]

  module E
    extend Packages::Internal::Type::Enum
  end

  module U
    extend Packages::Internal::Type::Union
  end

  class B < Packages::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Packages::Internal::Type::Unknown,
      Packages::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Packages::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Packages::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Packages::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Packages::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        Packages::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Packages::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Packages::Internal::Type::Boolean, true] => true,
      [Packages::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Packages::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Packages::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do
      ...
      assert_raises(_2) do
        Packages::Internal::Type::Converter.coerce(target, input, state: state)
      end
    end
  end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Packages::Internal::Type::Converter.dump(target, input, state: state)
...
class Packages::Test::EnumModelTest < Minitest::Test
  class E0
    include Packages::Internal::Type::Enum
    attr_reader :values
...
class Packages::Test::CollectionModelTest < Minitest::Test
  A1 = Packages::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Packages::Internal::Type::HashOf[Integer]

  A2 = Packages::Internal::Type::ArrayOf[H1]
  H2 = Packages::Internal::Type::HashOf[-> { A1 }]

  A3 = Packages::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Packages::Internal::Type::HashOf[Integer, nil?: true]
...
class Packages::Test::BaseModelTest < Minitest::Test
  class M1 < Packages::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Packages::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Packages::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Packages::Internal::Type::ArrayOf[M6]
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = {strictness: true, exactness: {yes: 0, no: 0, maybe: 0}, branched: 0}
      assert_pattern do
        coerced = Packages::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Packages::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      _2.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Packages::Errors::ConversionError => e
...
class Packages::Test::UnionTest < Minitest::Test
  class U0
    include Packages::Internal::Type::Union
  ...
  class M2 < Packages::Internal::Type::BaseModel
  ...
  class M4 < Packages::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Packages::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Packages::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Packages::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Packages::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Packages::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [Packages::Internal::Type::Unknown, Packages::Internal::Type::Unknown] => true,
      [Packages::Internal::Type::Boolean, Packages::Internal::Type::Boolean] => true,
      [Packages::Internal::Type::Unknown, Packages::Internal::Type::Boolean] => false,
