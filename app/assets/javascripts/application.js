...
$( document ).ready(function() {
  ...
  if ($('#files').length > 0) {
    ...
    var list_url = "https://archives.khulnasoft.com/api/v1/archives/list?url=" + download_url
    var contents_url = "https://archives.khulnasoft.com/api/v1/archives/contents?url=" + download_url + "&path=" + path
  ...
  if ($('#readme').length > 0) {
    var download_url = $('#files').data('url');
    var readme_url = "https://archives.khulnasoft.com/api/v1/archives/readme?url=" + download_url
