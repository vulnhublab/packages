...
module Ecosystem
  class Actions < Base
    ...
    def fetch_package_metadata(name)
      ...
      json = get_json("https://repos.khulnasoft.com/api/v1/repositories/lookup?url=https://github.com/#{full_name}")
    ...
    def recently_updated_package_names
      get_json("https://repos.khulnasoft.com/api/v1/package_names/actions").first(20)
    rescue
      []
    end
    ...
    def all_package_names
      get_json("https://repos.khulnasoft.com/api/v1/package_names/actions")
    rescue
      []
    end
