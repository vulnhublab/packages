...
module Ecosystem
  class Carthage < Base
    ...
    def fetch_package_metadata(name)
      json = get_json("https://repos.khulnasoft.com/api/v1/repositories/lookup?url=https://github.com/#{CGI.escape(name)}")
    ...
    def recently_updated_package_names
      json = get_json("https://repos.khulnasoft.com/api/v1/package_names/carthage")
      return [] if json.nil?
    ...
    def all_package_names
      get_json("https://repos.khulnasoft.com/api/v1/package_names/carthage")
    rescue
      []
    end
