      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            Packages::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: Packages::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: Packages::Internal::Util::ParsedUri,
            rhs: Packages::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[Packages::Internal::Util::ServerSentEvent]
          )
        end
