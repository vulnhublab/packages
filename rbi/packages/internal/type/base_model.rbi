    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Packages::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(Packages::Internal::Type::Converter::Input)
                  }
                )
              ]
            )
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  Packages::Internal::Type::BaseModel::KnownField,
                  { type: Packages::Internal::Type::Converter::Input }
                )
              ]
            )
          end
          ...
          sig do
            params(
                ...
                T.any(
                  {
                    ...
                    enum:
                      T.nilable(
                        T.proc.returns(
                          Packages::Internal::Type::Converter::Input
                        )
                      ),
                    union:
                      T.nilable(
              ...
              spec: Packages::Internal::AnyHash
            ).void
          end
        ...
        class << self
          ...
          sig do
            params(
              model: Packages::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(Packages::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(Packages::Internal::AnyHash) }
        def to_h
        end
