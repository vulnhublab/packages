    ...
    module Util
      ...
      class << self
        ...
        def coerce_hash!(input)
          ...
          in Hash | nil => coerced
            ...
            message = "Expected a #{Hash} or #{Packages::Internal::Type::BaseModel}, got #{data.inspect}"
      ...
      class << self
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          ...
          case val
          in Packages::FilePart unless val.filename.nil?
        ...
        def encode_content(headers, body)
          ...
          in [Packages::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [Packages::Internal::Util::JSONL_CONTENT, Enumerable] unless body.is_a?(Packages::Internal::Type::FileInput)
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | Packages::Internal::Type::FileInput]
        ...
        def decode_content(headers, stream:, suppress_error: false)
          ...
          in Packages::Internal::Util::JSON_CONTENT
          ...
          in Packages::Internal::Util::JSONL_CONTENT
