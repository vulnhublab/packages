    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Packages::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Packages::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Packages::FilePart.new(value)
          in Packages::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Packages::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Packages::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          def coerce(
            ...
            case target
            in Packages::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Packages::Internal::Type::Converter
              ...
              Packages::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Packages::Internal::Type::Converter, T::Class[T.anything]) }
        end
