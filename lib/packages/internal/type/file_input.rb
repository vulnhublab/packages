...
module Packages
  module Internal
    module Type
      ...
      # `Packages::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | Packages::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= Packages::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in Packages::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
            else
            end
