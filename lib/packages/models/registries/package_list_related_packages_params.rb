...
module Packages
  module Models
    module Registries
      # @see Packages::Resources::Registries::Packages#list_related_packages
      class PackageListRelatedPackagesParams < Packages::Internal::Type::BaseModel
        ...
        # @!method initialize(registry_name:, created_after: nil, order: nil, page: nil, per_page: nil, sort: nil, updated_after: nil, request_options: {})
