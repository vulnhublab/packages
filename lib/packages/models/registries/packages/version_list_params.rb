...
module Packages
  module Models
    module Registries
      module Packages
        # @see Packages::Resources::Registries::Packages::Versions#list
        class VersionListParams < Packages::Internal::Type::BaseModel
          ...
          # @!method initialize(registry_name:, created_after: nil, created_before: nil, order: nil, page: nil, per_page: nil, published_after: nil, published_before: nil, sort: nil, updated_after: nil, updated_before: nil, request_options: {})
