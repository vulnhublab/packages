...
module Packages
  module Models
    # @see Packages::Resources::Registries#list_recent_versions
    class RegistryListRecentVersionsParams < Packages::Internal::Type::BaseModel
      ...
      # @!method initialize(created_after: nil, created_before: nil, order: nil, page: nil, per_page: nil, published_after: nil, published_before: nil, sort: nil, updated_after: nil, updated_before: nil, request_options: {})
